...
./fork-action.sh acme/deploy-action --tag v7.0.8 --no-app

# Fork into a specific org/user
./fork-action.sh acme/deploy-action --tag v1.3.0 --org SamFleming-TylerTech --no-app
...
./fork-action.sh acme/deploy-action --existing --org SamFleming-TylerTech --no-app

# Update sync infra on an existing fork
./fork-action.sh acme/deploy-action --existing --force-update --org SamFleming-TylerTech --no-app
```
